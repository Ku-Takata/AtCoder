...
fn main() {
    ...
    let params = Params {
        ...
        pond_count_th: args.get(26).and_then(|s| s.parse().ok()).unwrap_or(887.1536694406896),
        pond_cluster_th: args.get(27).and_then(|s| s.parse().ok()).unwrap_or(2.045104993518539),
    };
